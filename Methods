...
W przypadku atrybucji myśli się o indywidualnych, nieświadomych wręcz rzadkich, specyficznych konfiguracjach językowych, które pozwalają jednocznacznie ustalić autorstwo.
...
## Działanie przykładowego systemu
- Załadowanie korpusu
- Wybór cech opisowych
- Określenie parametrów przetwarzania
- Wstępne przetwarzanie
- Obliczanie wartości cech
- Filtrowanie i/lub transformacja cech
- Przetwarzanie z pomocą grupowania albo klasyfikacji
